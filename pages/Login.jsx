...
function Login() {
  ...
  const [usuarioNoRegistrado, setUsuarioNoRegistrado] = useState(false);
  const [mostrarBotonInicioSesion, setMostrarBotonInicioSesion] = useState(false);
  ...
  const handleSubmit = (e) => {
    ...
    const usuarioRegistrado = usuarios.find(
      (usuario) =>
        usuario.username === formData.usuario && usuario.password === formData.password
    );
    ...
    if (usuarioRegistrado) {
      ...
      setMostrarBotonInicioSesion(true);
    } else {
      setUsuarioNoRegistrado(true);
      setMostrarBotonInicioSesion(false);
    }
  };
    ...
    <div className="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
      <div className="flex flex-col items-center justify-center">
        <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
          ...
          >
            No tienes una?{" "}
            <NavLink to="/registro" className="text-black font-bold">
              {" "}
              Registrate aqui
            </NavLink>
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-8">
              {mostrarBotonInicioSesion ? (
                <NavLink to={"/home"}>
                <button
                  onClick={() => alert("Nuevo botón después de iniciar sesión")}
                  role="button"
